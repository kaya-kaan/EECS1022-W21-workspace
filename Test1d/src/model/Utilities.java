...
public class Utilities
{
	...
	public static String getBMIReport(String unitOfWeight, double valueOfWeight, String unitOfHeight, double valueOfHeight) {
		...
		if ( !((unitOfWeight.equals("pound")) || (unitOfWeight.equals("kilogram"))) ) {
			...
			} else if (unitOfHeight.equals("foot")) {
	...
	public static String getSmallestTwoNumbers(int n1, int n2, int n3, int n4) {
		...
		if ( n1 <= n2 && n1 <= n3 && n1 <= n4) {
			result += "smallest is " + n1;
			if ( n2 <= n3 && n2 <= n4 ) {
				result += " and second smallest is " + n2;
			} else if ( n3 <= n2 && n3 <= n4 ) {
				result += " and second smallest is " + n3;
			} else if ( n4 <= n2 && n4 <= n3 ) {
				result += " and second smallest is " + n4;
			}
			
		} else if ( n2 <= n1 && n2 <= n3 && n2 <= n4) {
			result += "smallest is " + n2;
			if ( n1 <= n3 && n1 <= n4 ) {
				result += " and second smallest is " + n1;
			} else if ( n3 <= n1 && n3 <= n4 ) {
				result += " and second smallest is " + n3;
			} else if ( n4 <= n1 && n4 <= n3 ) {
				result += " and second smallest is " + n4;
	...
	public static String getLoserOfRPS(String p1, char p1Option, String p2, char p2Option) {
    	...
    	if ( (p1Option == 'r' && p2Option == 'p') || (p1Option == 'p' && p2Option == 's') || (p1Option == 's' && p2Option == 'r') ) {
    		result = p1;
    	} else if ( (p2Option == 'r' && p1Option == 'p') || (p2Option == 'p' && p1Option == 's') || (p2Option == 's' && p1Option == 'r') ) {
    		result = p2;
    	} else if ( (p1Option == 'r' && p2Option == 'r') || (p1Option == 'p' && p2Option == 'p') || (p1Option == 's' && p2Option == 's') ) {
    		result = "tie";
    	}
